...
export const LoginPage = () => {
    ...
    return (
        <div className="mx-auto my-20 flex w-full max-w-sm flex-col gap-5 rounded-2xl border border-gray-100 bg-white p-8 shadow-xl">
            ...
            <p className="-mt-3 text-sm text-gray-500">Don't have an account?<Link to={{pathname: "/register"}} className="ml-1 cursor-pointer font-medium text-indigo-600 hover:underline">Sign up free</Link></p>
