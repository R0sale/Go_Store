...
export const loadCatalogItems = async (): Promise<item[] | null> => {
    ...
    console.log(import.meta.env.VITE_CATALOG_URL + "/api/catalog")
    const { ok, response } = await apiService.apiCall(import.meta.env.VITE_CATALOG_URL + "/api/get/catalog", "POST")
